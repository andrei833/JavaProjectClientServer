...
public class StartJsonClient {
    ...
    public static void main(String []args){
        ...
        try {
            ...
            Map<Race, Integer> result = server.getAllRacesWithParticipantCount();
            System.out.println("Races and participants: " + result);

            System.out.println("Creating a registration...");
